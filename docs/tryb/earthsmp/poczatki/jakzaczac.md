...
Po dołączeniu na serwer **EarthSMP**, zalecamy odebrać zestawy przygotowane specjalnie dla nowych graczy:

- 🎒 **Zestaw Gracza**
- 🍖 **Zestaw Jedzenia**

Zestawy znajdziesz pod komendą **`/kit`**.

Na spawnie spotkasz wielu NPC-ów — najważniejsi znajdują się w samym centrum. Ich funkcje (od lewej) to:

- **💼 NPC Prace**  
  Kliknij, aby wybrać jedną z dostępnych prac. Więcej informacji o systemie prac znajdziesz poniżej.

- **🧭 NPC Losowa Teleportacja**  
  Otwiera GUI, w którym możesz wybrać kontynent, na który chcesz się teleportować — albo losowo przenieść się gdziekolwiek, w tym także do Netheru.

...
<Tabs>
  ...
  <TabItem value="dzialanie" label="Działanie" default>
    ...
    **Hot Spot** nie działa podczas deszczu. Użyj do tego **Call of the Storm**.
    ...
    Jest to jedno z pierwszych ulepszeń, które wprowadzisz i jedno z najlepszych dla graczy na początku i na końcu gry, aby zmaksymalizować potencjał patroszenia wynikający z posiadania dużej ilości ryb.
  ...
  <TabItem value="statystyki" label="Statystyki">
    ...
    * **Entropia do stworzenia**: 50,000
    * **Potrzebna całkowita entropia**: 650,000
  </TabItem>
  
  <TabItem value="skladniki" label="Składniki">
    | Materiały    | Jedno ulepszenie | Maksymalny poziom|
    | ------------ | ---------------- | --------------|
  ...
  <TabItem value="procenty" label="Procenty">
     1. 2%
     2. 4%
     3. 6%
     4. 8%
...
<Tabs>
  ...
  <TabItem value="dzialanie" label="Działanie" default>
    **Sage** daje ci więcej punktów doświadczenia za każdy raz, kiedy złowisz rzadką rybkę.
  </TabItem>

  <TabItem value="statystyki" label="Statystyki">
    * **Wymagany poziom**: 16
    * **Maksymalny poziom**: 10
    * **Entropia do stworzenia**: 57,500
    * **Potrzebna całkowita entropia**: 575,000
  </TabItem>
  ...
  <TabItem value="skladniki" label="Składniki">
    ...
    | --------------- |---------------- | --------------
    | Blok złota | 8x | 80x
    | Łuska Kraba | 16x | 160x
    | Pazur Kraba | 16x | 160x
    | Ogon Delfina | 3x | 10x
    | Proch | 4x | 40x
    | Redstone | 16x | 160x
    | Cukier | 16x | 160x
...
<Tabs>
  ...
  <TabItem value="statystyki" label="Statystyki">
    * **Wymagany poziom**: 16
    * **Maksymalny poziom**: 3
    * **Entropia do stworzenia**: 60,000
    * **Potrzebna całkowita entropia**: 180,000
  </TabItem>
...
<Tabs>
  ...
  <TabItem value="statystyki" label="Statystyki">
    * **Wymagany poziom**: 22
    * **Maksymalny poziom**: 8
    * **Entropia do stworzenia**: 70,000
    * **Potrzebna całkowita entropia**: 560,000
  </TabItem>
  ...
  <TabItem value="skladniki" label="Składniki">
    ...
    | --------------- | ---------------- | --------------
    | Kowadło | 1x | 8x
    | diamentowy miecz | 16x | 128x
    | żelazna sikierka | 1x | 8x
    | Bruk | 16x | 128x
    | Szmaragdy | 2x | 16x
    | Blok lazurytu | 3x | 24x
    | Wiadro z wodą | 1x | 8x
    | Głowa netherowego szkieleta | 1x | 8x
    | Muszla | 6x | 48x
  </TabItem>
...
<Tabs>
  ...
  <TabItem value="statystyki" label="Statystyki">
    ...
    * **Maksymalny poziom**: 10
    * **Entropia do stworzenia**: 50,000
    * **Potrzebna całkowita entropia**: 500,000
  </TabItem>

  <TabItem value="skladniki" label="Składniki">
    | Materiały | Jedno ulepszenie | Maksymalny poziom
    | --------------- | ---------------- | --------------
    | Blok lazurytu | 20x | 200x
    | Książka | 8x | 80x
    | Diament | 8x | 80x
    | Blok szmaragdu | 8x | 80x
    | Luska Kraba | 16x | 160x
  </TabItem>
...
<Tabs>
  ...
  <TabItem value="statystyki" label="Statystyki">
    * **Wymagany poziom:** 28
    * **Maksymalny poziom:** 7
    * **Entropia do stworzenia:** 75,000
    * **Potrzebna całkowita entropia:** 525,000
  </TabItem>
...
<Tabs>
  ...
  <TabItem value="statystyki" label="Statystyki">
    ...
    * **Maksymalny poziom**: 6
    * **Entropia do stworzenia**: 60,000
    * **Potrzebna całkowita entropia**: 360,000
  </TabItem>

  <TabItem value="skladniki" label="Składniki">
    | Materiały | Jedno ulepszenie | Maksymalny poziom
    | --------------- | ---------------- | --------------
    | Blok żelaza | 32x | 192x
    | Blok złota |16x | 96x
    | Blok diamentu | 12x | 72x
    | Blok szmaragdu | 12x | 72x
    | Macka Kałamarnicy | 16x | 96x
    | Serce oceanu | 1x | 6x
  </TabItem>
...
<Tabs>
  ...
  <TabItem value="statystyki" label="Statystyki">
    ...
    * **Maksymalny poziom**: 5
    * **Entropia do stworzenia**: 75,000
    * **Potrzebna całkowita entropia**: 375,000
  </TabItem>
  ...
  <TabItem value="skladniki" label="Składniki">
    ...
    | --------------- | ---------------- | --------------
    | Blok złota | 8x | 40x 
    | Blok diamentu | 5x | 25x
    | Blok szmaragdu | 12x | 60x
    | Pazur Kraba | 10x | 50x
    | Luska Kraba | 10x | 50x
    | Macka Kałamarnicy | 10x | 50x
  </TabItem>
...
<Tabs>
  ...
  <TabItem value="statystyki" label="Statystyki">
    ...
    * **Entropia do stworzenia**: 120,000
    * **Potrzebna całkowita entropia**: 2,400,000
  </TabItem>

  <TabItem value="skladniki" label="Składniki">
    | Materiały | Jedno ulepszenie | Maksymalny poziom
    | --------------- | ---------------- | --------------
    | Netherowa gwiazda | 1x | 20x
    | Łza ghasta | 8x | 160x
    | Pazur kraba | 16x | 320x
    | Łuska kraba | 16x | 320x
    | Ogon Delfina | 8x | 160x
    | Macka kałamarnicy | 12x | 240x
    | Serce oceanu | 2x | 40x
  </TabItem>

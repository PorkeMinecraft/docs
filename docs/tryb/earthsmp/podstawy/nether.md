...
- Występuje: Wszędzie 🌍
- Drop Fragmentów Netherowej Zbroi: TAK (1 3%) ⚔️

### 😈 Mroczny Chochlik {#mroczny-chochlik}
...
- Drop Fragmentów Netherowej Zbroi: TAK (1 5%) ⚔️

### 🍄 Piekielny Grzyb {#piekielny-grzyb}
...
### 🔥 Ognisty Chochlik {#ognisty-chochlik}
...
- Występuje: Wszędzie 🌍
- Drop Fragmentów Netherowej Zbroi: TAK (1-3 30%) ⚔️

## ⚒️ Fragmenty Netherowej Zbroi {#fragmenty}
...
### 🏆 Zbieranie Fragmentów {#zbieranie-fragmentow}
...
## ⚔️ Zbroja Netherowa {#zbroja}

![Netherowa Zbroja](./assets/netherowa-zbroja.png)

### 🛠️ Crafting Netherowej Zbroi {#crafting-zbroi}
...
#### 🛡️ Netherowy Napierśnik {#napiersnik}

![Netherowy Napierśnik](./assets/netherowy-napiersnik.png)

#### 👖 Netherowe Nogawice {#nogawice}
